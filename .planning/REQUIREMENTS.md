...
- [x] **SRCH-01**: Fan can search existing artists in Decibel database with autocomplete
...
- [x] **LOC-04**: If fan is at a venue with an active event, non-intrusive banner appears: "[Artist] is playing at [Venue]. Collect?"
- [x] **LOC-05**: Multiple-artist lineups show all artists with individual collect buttons
- [x] **LOC-06**: "I'm at a show" manual trigger on Home screen as fallback for auto-detection
...
- [x] **NOTIF-02**: Fan receives "nearby event" notification when artist they've collected is playing nearby
- [x] **NOTIF-03**: Fan receives "badge earned" notification on badge unlock
- [x] **NOTIF-04**: Fan receives "tier up" notification on tier progression
- [x] **NOTIF-05**: Fan receives "artist message" notification when a DJ messages fans
- [x] **NOTIF-06**: Fan receives "friend joined" notification when a phone contact joins Decibel
- [x] **NOTIF-07**: Fan receives weekly recap notification summarizing shows, collections, badges
...
- [x] **POLISH-02**: Offline support with cached passport and artist data
- [x] **POLISH-03**: Collection confirmation stamp animation with haptic feedback
- [x] **POLISH-04**: Badge unlock starburst animation with haptic feedback
- [x] **POLISH-05**: Passport parallax header scroll effect
